...
const Ftp = () => (
  <div style={container}>
    ...
    <form style={btnWrapper} method="post" action="http://localhost:4000/ftp/upload" encType="multipart/form-data">
      <button style={btn} type="submit" >upload file</button>
      <input style={input} type="file" name="sampleFile"/>
    </form>
    <form method="post" action="http://localhost:4000/ftp/download" encType="multipart/form-data">
      <button style={btn} type="file" name="" value="dfile">download picture</button>
    </form>
    <form method="get" action="http://localhost:4000/ftp/getUploadedFiles" encType="multipart/form-data">
